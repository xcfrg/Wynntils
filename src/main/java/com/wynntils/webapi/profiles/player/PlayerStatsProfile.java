...
public class PlayerStatsProfile {
    ...
    public PlayerStatsProfile(String username, String uuid, PlayerRank rank, Date firstJoin, Date lastJoin, boolean online, String server, int playtime, boolean displayTag, PlayerTag tag, boolean veteran, ArrayList<PlayerClassProfile> classes, String guildName, GuildRank guildRank, int chestsFound, long blocksWalked, int itemsIdentified, int mobsKilled, int totalCombatLevel, int totalProfessionLevel, int totalLevel, int pvpKills, int pvpDeaths, int logins, int deaths, int discoveries, int eventsWon, int guildRanking, int combatLevelRanking, int woodcuttingLevelRanking, int miningLevelRanking, int fishingLevelRanking, int farmingLevelRanking, int alchemismLevelRanking, int armouringLevelRanking, int cookingLevelRanking, int jewelingLevelRanking, int scribingLevelRanking, int tailoringLevelRanking, int weaponsmithingLevelRanking, int woodworkingLevelRanking, int professionLevelRanking, int overallLevelRanking, int overallAllRanking, int combatRanking, int professionRanking, int pvpRanking) {
    ...
    public static class PlayerStatsProfileDeserializer implements JsonDeserializer<PlayerStatsProfile> {
        ...
        public PlayerStatsProfile deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
            ...
            String server = null;
            if (!playerLocation.get("server").isJsonNull()) server = playerLocation.get("server").getAsString();
            ...
            int guildRanking = 0;
            if (!rankings.get("guild").isJsonNull()) guildRanking = rankings.get("guild").getAsInt();
            ...
            if (!soloRankings.get("combat").isJsonNull()) combatLevelRanking = soloRankings.get("combat").getAsInt();
            int woodcuttingLevelRanking = 0;
            if (!soloRankings.get("woodcutting").isJsonNull()) woodcuttingLevelRanking = soloRankings.get("woodcutting").getAsInt();
            int miningLevelRanking = 0;
            if (!soloRankings.get("mining").isJsonNull()) miningLevelRanking = soloRankings.get("mining").getAsInt();
            int fishingLevelRanking = 0;
            if (!soloRankings.get("fishing").isJsonNull()) fishingLevelRanking = soloRankings.get("fishing").getAsInt();
            int farmingLevelRanking = 0;
            if (!soloRankings.get("farming").isJsonNull()) farmingLevelRanking = soloRankings.get("farming").getAsInt();
            int alchemismLevelRanking = 0;
            if (!soloRankings.get("alchemism").isJsonNull()) alchemismLevelRanking = soloRankings.get("alchemism").getAsInt();
            int armouringLevelRanking = 0;
            if (!soloRankings.get("armouring").isJsonNull()) armouringLevelRanking = soloRankings.get("armouring").getAsInt();
            int cookingLevelRanking = 0;
            if (!soloRankings.get("cooking").isJsonNull()) cookingLevelRanking = soloRankings.get("cooking").getAsInt();
            int jewelingLevelRanking = 0;
            if (!soloRankings.get("jeweling").isJsonNull()) jewelingLevelRanking = soloRankings.get("jeweling").getAsInt();
            int scribingLevelRanking = 0;
            if (!soloRankings.get("scribing").isJsonNull()) scribingLevelRanking = soloRankings.get("scribing").getAsInt();
            int tailoringLevelRanking = 0;
            if (!soloRankings.get("tailoring").isJsonNull()) tailoringLevelRanking = soloRankings.get("tailoring").getAsInt();
            int weaponsmithingLevelRanking = 0;
            if (!soloRankings.get("weaponsmithing").isJsonNull()) weaponsmithingLevelRanking = soloRankings.get("weaponsmithing").getAsInt();
            int woodworkingLevelRanking = 0;
            if (!soloRankings.get("woodworking").isJsonNull()) woodworkingLevelRanking = soloRankings.get("woodworking").getAsInt();
            int professionLevelRanking = 0;
            if (!soloRankings.get("profession").isJsonNull()) professionLevelRanking = soloRankings.get("profession").getAsInt();
            int overallLevelRanking = 0;
            if (!soloRankings.get("overall").isJsonNull()) overallLevelRanking = soloRankings.get("overall").getAsInt();
            JsonObject overallRankings = playerRankings.get("overall").getAsJsonObject();
            int overallAllRanking = 0;
            if (!overallRankings.get("all").isJsonNull()) overallAllRanking = overallRankings.get("all").getAsInt();
            int combatRanking = 0;
            if (!overallRankings.get("combat").isJsonNull()) combatRanking = overallRankings.get("combat").getAsInt();
            int professionRanking = 0;
            if (!overallRankings.get("profession").isJsonNull()) professionRanking = overallRankings.get("profession").getAsInt();
            int pvpRanking = 0;
            if (!rankings.get("pvp").isJsonNull()) pvpRanking = rankings.get("pvp").getAsInt();
            return new PlayerStatsProfile(username, uuid, rank, firstJoin, lastJoin, online, server, playtime, displayTag, tag, veteran, classes, guildName, guildRank, chestsFound, blocksWalked, itemsIdentified, mobsKilled, totalCombatLevel, totalProfessionLevel, totalLevel, pvpKills, pvpDeaths, logins, deaths, discoveries, eventsWon, guildRanking, combatLevelRanking, woodcuttingLevelRanking, miningLevelRanking, fishingLevelRanking, farmingLevelRanking, alchemismLevelRanking, armouringLevelRanking, cookingLevelRanking, jewelingLevelRanking, scribingLevelRanking, tailoringLevelRanking, weaponsmithingLevelRanking, woodworkingLevelRanking, professionLevelRanking, overallLevelRanking, overallAllRanking, combatRanking, professionRanking, pvpRanking);
        }
    }
}
