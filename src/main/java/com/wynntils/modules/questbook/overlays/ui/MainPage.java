...
public class MainPage extends QuestBookPage {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        ScreenRenderer.beginGL(0, 0);
        {
            ...
            InventoryScreen.drawEntityOnScreen(x + 80, y + 30, 30, right, up, Minecraft.getInstance().player);
        }
        ...
        ScreenRenderer.beginGL(0, 0);
        {
            ...
            render.drawString(Minecraft.getInstance().player.getName(), x + 80, y - 43, CommonColors.BLACK, SmartFontRenderer.TextAlignment.MIDDLE, SmartFontRenderer.TextShadow.NONE);
