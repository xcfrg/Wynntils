...
public class MusicPlayer {
    ...
    public void update() {
        ...
        // update the volume
        float baseVolume = -36 + (36 * McIf.mc().options.getSoundSourceVolume(SoundCategory.RECORDS));
    ...
    private void initialize() {
        ...
        musicThread = new Thread(() -> {
            try {
                ...
                // updating the volume
                float baseVolume = -32 + (32 * McIf.mc().options.getSoundSourceVolume(SoundCategory.RECORDS));
