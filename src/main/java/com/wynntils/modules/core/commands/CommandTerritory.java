...
public class CommandTerritory extends CommandBase implements IClientCommand {
    ...
    public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
        if (args.length <= 0) {
            Minecraft.getMinecraft().player.play(SoundEvents.BLOCK_ANVIL_PLACE, 1.0f, 1.0f);
        ...
        Minecraft.getMinecraft().player.play(SoundEvents.ENTITY_PLAYER_LEVELUP, 1.0f, 10.0f);
